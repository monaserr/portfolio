...
export const DEFAULT_DATA: PortfolioData = {
  ...
  projects: [
    {
      ...
      highlights: ["Arabic-first UX with RTL support", "Optimized MongoDB queries", "Firebase + Railway deployment", "Full auth & order management"],
      github: "https://github.com/monaserr",
    },
    {
      id: "genbyte",
      ...
      year: "2026",
      status: "live",
      description: "Full-stack system for biological data analysis and visualization.",
      tech: ["React", "Node.js", "Express", "MongoDB", "Vercel", "Railway"],
      highlights: ["DNA/RNA dataset analysis", "Interactive visualizations", "REST APIs for computation", "Deployed on Vercel & Railway"],
      github: "https://github.com/monaserr",
    },
    {
      id: "freelance",
      ...
      highlights: ["95+ Lighthouse score", "Multi-page with animations", "Full branding system", "SEO-optimized"],
      github: "https://github.com/monaserr",
    },
    {
      id: "gc-analyzer",
      ...
      status: "wip",
      description: "Python tool for DNA/RNA FASTA sequence analysis with Matplotlib visualizations.",
      tech: ["Python", "Matplotlib", "FASTA", "Bioinformatics"],
      highlights: ["60% reduction in analysis time", "Automated GC calculation", "Matplotlib visualizations", "FASTA parsing"],
      github: "https://github.com/monaserr",
    },
    {
      id: "student-hub",
      ...
      year: "2024",
      status: "live",
      description: "Academic platform adopted by the entire student cohort at Benha University.",
      tech: ["React", "Node.js", "MongoDB"],
      highlights: ["Adopted by full cohort", "Centralized study resources", "Communication channels", "University-scale"],
      github: "https://github.com/monaserr",
    },
    {
      id: "fullstackopen",
      ...
      highlights: ["Parts 0-1 completed", "React & Vite", "REST API design", "Ongoing certification"],
  ...
  messages: [
    ...
    { id: "2", name: "Sarah Johnson", email: "sarah@agency.com", message: "We have a React developer opening. Your profile looks great!", date: "2026-01-14", read: false },
  ],
};
...
export function saveData(data: PortfolioData): void {
  ...
  // Dispatch event so portfolio page can react
